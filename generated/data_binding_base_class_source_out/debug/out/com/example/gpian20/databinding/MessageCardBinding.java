...
public final class MessageCardBinding implements ViewBinding {
  ...
  private MessageCardBinding(@NonNull LinearLayout rootView, @NonNull CardView developerCard,
  ...
  public static MessageCardBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MessageCardBinding((LinearLayout) rootView, developerCard, imagecard, mainCard,
          message, textlayout, timeStamp, userimage, username);
    }
